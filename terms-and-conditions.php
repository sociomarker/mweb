...
Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the demo.astoundify.com/listify website (the "Service") operated by Listify ("us", "we", or "our").
